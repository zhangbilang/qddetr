...
def ms_deform_attn_core_pytorch(
    ...
    value_mult = value_mult.reshape(N_, M_, D_, Lq_, L_ * P_)
...
class QuantMS_DAttention(nn.Module):
    def __init__(self, d_model=256, n_levels=4, n_heads=8, n_points=4, n_bit=4):
        ...
        self.v_act = ActLSQ(nbits_a=n_bit, in_features=n_heads)
        self.attn_act = ActLSQ(nbits_a=n_bit, in_features=n_heads)
