...
from .lsq_plus import ActLSQ, LinearLSQ
...
class QuantMultiheadAttention(nn.Module):
    ...
    def __init__(self, embed_dim, num_heads, n_bit=4, dropout=0., bias=True, add_bias_kv=False, add_zero_attn=False, kdim=None, vdim=None, dist_align=True):
        ...
        self.qf_act = ActLSQ(nbits_a=n_bit, in_features=embed_dim)
        self.kf_act = ActLSQ(nbits_a=n_bit, in_features=embed_dim)
        self.vf_act = ActLSQ(nbits_a=n_bit, in_features=embed_dim)
